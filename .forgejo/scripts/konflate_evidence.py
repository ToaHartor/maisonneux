#!/usr/bin/env python3
"""https://github.com/joryirving/home-ops/blob/main/.github/scripts/konflate_evidence.py
...
def main():
    ...
    try:
        ...
        diff = _text(
            call(
                "tools/call", {"name": "get_pr_diff", "arguments": {"number": int(PR)}}
            )
        )
    ...
    findings = []
    src = f"http://konflate.services.svc.cluster.local:8080/#/pr/{PR}"
